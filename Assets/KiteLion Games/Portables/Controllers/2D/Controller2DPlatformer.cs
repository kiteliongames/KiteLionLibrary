...
public class Controller2DPlatformer : PlayerController {
    ...
    //        KiteLionGames.BetterDebug.CBUG.Log("Str List: " + StrengthsList.ToStringFull());
    //        jumpForceTemp = 0f;
    //        SpeedTemp = 0f;
    ...
    //            jumped = true;
    //            KiteLionGames.BetterDebug.CBUG.Log("Jumped is true!");
    //            jumpsRemaining -= 1;
    ...
    //            KiteLionGames.BetterDebug.CBUG.Log("Move axis: " + tempAxisTouch);
    //            moveLeft = 0;
    ...
    //        if (downJumped) {
    //            KiteLionGames.BetterDebug.CBUG.Log("DownJumped");
    ...
    //            jumped = false;
    //            KiteLionGames.BetterDebug.CBUG.Log("Jumped is false!");
    //        }
    ...
    //            KiteLionGames.BetterDebug.CBUG.Log("Grounded on: " + (hit.collider.name));
    //            jumpsRemaining = TotalJumpsAllowed;
    ...
    //        }
    //        else {
    //            KiteLionGames.BetterDebug.CBUG.Log("No Raycast Contact.");
    //        }
