    ...
    namespace Controllers {
        ...
        public abstract class ControllerThirdPerson : PlayerController {
            ...
            public void Start() {
                ...
                //fixthisstaticphotonviewif (_PhotonView.IsMine) {
                //fixthisstaticphotonview    tag = "PlayerSelf";
                //fixthisstaticphotonview    //_PhotonView.RPC("SetSlotNum", RpcTarget.All, NetID.ConvertToSlot(PhotonNetwork.player.ID));
                //fixthisstaticphotonview}
