...
namespace KiteLionGames.KiteLionLibrary.Portables.Legal
{
    namespace Legal
    {
        public static class Copyright
        {
            private static readonly Dictionary<ILegal, UsageStats> KiteLionGamesSoftware = new Dictionary<ILegal, UsageStats>();
